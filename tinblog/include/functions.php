...
function comments_fields($id,$pre_post_id=0)
{
				...
				echo '<input type=\'hidden\' name=\'user_ip\' class=\'name\' value=\''.$_SERVER['REMOTE_ADDR'].'\'></input>';
				echo '<input type=\'hidden\' name=\'user_agent\' class=\'name\' value=\''.$_SERVER['HTTP_USER_AGENT'].'\'></input>';
